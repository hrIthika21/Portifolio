            ...
            <div className="all-cards">
                <div className="project-card-1">
                    ...
                    <div className="project-card-1-part-2">
                        <a href="https://github.com/hrIthika21/hrIthika21.github.io.git"><img src="../src/assets/Screenshot 2024-08-10 at 12.06.44 PM.jpg" alt="project-1" className="project-1" /></a>
                ...
                <div className="project-card-2">
                    ...
                    <div className="project-card-2-part-2">
                        <a href="https://github.com/hrIthika21/tic-tac-toe-game.git"><img src="../src/assets/Screenshot 2024-08-10 at 12.10.05 PM.jpg" alt="project-2" className="project-2" /></a>
                ...
                <div className="project-card-3">
                    ...
                    <div className="project-card-3-part-2">
                        <a href="https://github.com/hrIthika21/Expense_tracker.git"><img src="../src/assets/Screenshot 2024-08-10 at 12.11.43 PM.jpg" alt="project-3" className="project-3"/></a>
